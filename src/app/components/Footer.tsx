  ...
  return (
    <footer className="sm:p-5 w-full relative overflow-hidden mt-10">
      ...
      <div className="flex flex-col relative items-center mt-10">
        ...
        <Link className="mt-5 mb-10 sm:mb-5" href="/register"><Image className="w-40 md:w-60 shadow-[-10px_10px_32px_-11px_rgba(0,0,0,0.7)] hover:shadow-none active:shadow-[inset_-100px_10px_32px_-11px_rgba(0,0,0,0.7)] rounded-lg" src={moreInfoButton} alt="For more info, click here!" /></Link>
      </div>
    </footer>
  )
}
