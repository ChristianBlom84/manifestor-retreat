    ...
    <>
      ...
      <div className="flex flex-row justify-evenly lg:justify-center flex-wrap md:flex-nowrap">
        <article className="w-11/12 sm:w-4/5 md:w-2/5 md:mr-10 lg:mr-20 xl:w-1/3 2xl:w-1/4">
          ...
          <p>
            Informing is an art. It is the way we build the bridge across this
            closeness of ours, and it&apos;s not necessarily a natural thing for
            us. But it&apos;s our strategy, and it works.
          </p>
          <p>
            Correct informing goes hand in hand with inspiration. It is actually
            initiation itself, our power going from a motor to the throat,
            expressing our inner form and manifesting as a new formation
            outside.
          </p>
          <p>
            When we are anchored in the form, connected deeply to inner
            authority and to our spirit, informing becomes a beautiful process
            of inner knowing, and a whole new way of communicating in resonance
            to what we truly are as beings.
          </p>
          <p>We manifest with words.</p>
          <p>
            In the retreat we will dive deeply into the concept and truth of
            informing, and experiment with it together, until we OWN it in a
            deeper sense.
          </p>
        </article>
        <article className="w-11/12 sm:w-4/5 md:w-2/5 xl:w-1/3 2xl:w-1/4">
