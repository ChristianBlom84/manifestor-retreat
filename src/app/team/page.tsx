    ...
    <>
      ...
      <div className="flex flex-col items-center md:items-start md:flex md:flex-row md:justify-evenly mb-20">
        <div className="w-11/12 sm:w-4/5 md:w-2/5">
          ...
          <p>
            In the retreat, I will be facilitating a chi Kong practice 3
            mornings. I practice Chinese martial arts for 25 years now. I
            practice and teach with much love to this amazing body path I chose.
            I&apos;m excited to do some practices with you, that will connect us
            more deeply to our unique center, to the special deep silence and
            quiet zone in us, the one that initiates the most wanted peaceful
            state that is influencing and impacting both inwards and outwards.
            See you with big curiosity.
          </p>
        </div>
        <div className="w-11/12 sm:w-4/5 md:w-2/5">
